...
export default function DivisionCard({ item }: DivisionCardProps) {
  return (
    <Link
      href={item.path || '#'}
    ...
    >
      ...
      <div>
        {(item as any).chiefJudge && (
          <span className="inline-block text-xs font-semibold text-accent-600 tracking-wider uppercase mb-2">
            {(item as any).chiefJudge}
          </span>
        )}
