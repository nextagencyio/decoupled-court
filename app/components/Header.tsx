        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity duration-200">
              <div className="flex-shrink-0 w-9 h-9 bg-primary-900 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">WDC</span>
              </div>
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/contact"
                className={clsx(
                  'hidden sm:inline-flex items-center bg-accent-600 text-white px-5 py-2 rounded-lg hover:bg-accent-500 transition-colors duration-200 font-semibold text-sm',
            ...
            <div className="lg:hidden border-t border-slate-200 py-4">
              <nav className="flex flex-col space-y-1">
                {navigationItems.map((item) => (
                  <Link
                    ...
                    className={clsx(
                      ...
                      activeTab === item.name
                        ? 'text-primary-900 bg-accent-50 border-l-2 border-accent-600'
                ...
                <Link
                  href="/contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="mx-4 mt-2 text-center bg-accent-600 text-white px-5 py-2.5 rounded-lg hover:bg-accent-500 transition-colors duration-200 font-semibold text-sm"
                >
                  Contact Us
                </Link>
              </nav>
