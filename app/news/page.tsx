...
export const metadata: Metadata = {
  title: 'News | Westfield District Court',
  description: 'Latest news and announcements from Westfield District Court.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-300">
              Stay informed with the latest news from Westfield District Court.
            </p>
          </div>
        </div>
      </section>
