...
export const metadata: Metadata = {
  title: 'Resources | Westfield District Court',
  description: 'Court resources, forms, and filing information from Westfield District Court.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-300">
              Access forms, filing guides, and legal resources.
            </p>
          </div>
        </div>
      </section>
